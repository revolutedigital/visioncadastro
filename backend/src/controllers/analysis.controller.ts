    ...
    try {
      ...
      const clientes = await prisma.cliente.findMany({
        ...
        select: {
          ...
          // Campos CNPJA/Receita Federal
          cnpj: true,
          cpf: true,
          razaoSocial: true,
          nomeFantasia: true,
          enderecoReceita: true,
          situacaoReceita: true,
          dataAberturaReceita: true,
    ...
    try {
      ...
      return res.json({
        ...
        cliente: {
          ...
          enderecoReceita: cliente.enderecoReceita,
          situacaoReceita: cliente.situacaoReceita,
          dataAberturaReceita: cliente.dataAberturaReceita,
          ...
          cidadeNormalizada: cliente.cidadeNormalizada,
          estadoNormalizado: cliente.estadoNormalizado,
          normalizacaoStatus: cliente.normalizacaoStatus,
          normalizacaoConfianca: cliente.normalizacaoConfianca,
          // Geocodificação
